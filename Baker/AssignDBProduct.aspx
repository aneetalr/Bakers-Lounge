<%@ Page Title="" Language="C#" MasterPageFile="~/Baker/BakerMasterPage.master" AutoEventWireup="true" CodeFile="AssignDBProduct.aspx.cs" Inherits="Baker_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
    <asp:GridView ID="grd_deliveryboy" runat="server" AutoGenerateColumns="False" Width="1350px" OnSelectedIndexChanged="grd_deliveryboy_SelectedIndexChanged" ShowHeaderWhenEmpty="true" OnRowCommand="grd_deliveryboy_RowCommand">
        <Columns>
